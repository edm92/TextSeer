...
public class AccumulationExample {
    ...
    public static void main(String[] args) {
        ...
        LinkedList<Trace> traces = loadModel("models/Model1.bpmn20.xml");    // Loading a model and convert into a set of traces
        LinkedList<Trace> traces2 = loadModel("models/Benefits Administration - Ongoing.bpmn20.xml");    // Loading a model and convert into a set of traces
        
        
        // Iterate through each trace.
        a.e.println("Trying to compute accumulation on process without QOS");
        a.e.incIndent();
        if (traces != null) {  	showAccumulationForTrace(traces);     }
        a.e.decIndent(); 
        a.e.println("Trying to compute accumulation on process with QOS");
        a.e.incIndent();
        if (traces2 != null) {  	showAccumulationForTrace(traces2);     }
...
//			}
    ...
    public static LinkedList<Trace> loadModel(String name) {
        ...
        Graph<Vertex, Edge> g1 = gLoader.loadModel(name, a.e.DONT_SAVE_MESSAGES_AND_PARTICIPANTS);
