...
public class properties{
        ...
        public static void loadProperties(){
                ...
                try {
                    ...
                    if(in == null) {System.out.println("Null in"); System.exit(-1); };
                    ...
                    debugMode = in.getProperty("debugMode").toLowerCase().compareTo("true") == 0? true : false;
                    sessionLength = Long.parseLong(in.getProperty("sessionLength"));
                    if(sessionLength == 0) sessionLength = 1209600000;  // If 0 then make it 1 weeks
                } catch (IOException e) {
