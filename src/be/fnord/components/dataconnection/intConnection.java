...
public interface intConnection {
         ...
         * @param serverName e.g. mysql://localhost/
         * @param database e.g. feedback
         * @param userName e.g. root
         * @param password e.g. pass
         * @return
         */
        public boolean makeConnection(String driver, 
                                        String serverName, 
                                        String database,
                                        String userName, 
                                        String password);
        ...
        /** Created a prepared statement. Should be executed using executeQuery.execute  * 
         * @param query
         * @return
         */
