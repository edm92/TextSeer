...
public class Relatedness {
    ...
    public void testOnSameSynsets() {
            ...
            assertEquals(1, rc.calcRelatednessOfSynset(n1Synsets.get(0), n1Synsets.get(0)).getScore(), 0.0001 );
    }
    
    @Test
    public void testOnUnknownSynsets() {
            assertEquals(0, rc.calcRelatednessOfSynset(null, n1Synsets.get(0)).getScore(), 0.0001 );
