 ...
 */
public class Graph_ST<v extends Vertex_ST, e extends Edge_ST> extends
		DefaultDirectedGraph<Vertex_ST, Edge_ST> implements
		org.jgrapht.Graph<Vertex_ST, Edge_ST> {
